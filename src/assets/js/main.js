/* =====================================
Template Name: Softtar
Author Name: Softtar
Description: Softtar is a Multipurpose Business HTML5 Theme. It's Perfect for any business websites. You can customize every section as your need.
Version:	1.0
========================================*/    
/*=======================================
...
(function ($) {
    ...
    $(document).ready(function(){	
		...
		if ($('#myMap').length > 0) {
			...
			var contentString = '<div id="mapcontent">' + '<p>Softtar World, 123 Folsom Ave, San Francisco.</p></div>';
